...
if ($ExecutionContext.SessionState.LanguageMode -ne 'FullLanguage') {
    Write-Host "PCTG System Master is unable to run on your system, PowerShell execution is restricted by security policies" -ForegroundColor Red
    return
}

if (!([Security.Principal.WindowsPrincipal][Security.Principal.WindowsIdentity]::GetCurrent()).IsInRole([Security.Principal.WindowsBuiltInRole]::Administrator)) {
    Write-Output "PCTG System Master needs to be run as Administrator. Attempting to relaunch."
    $argList = @()
    ...
    $script = if ($PSCommandPath) {
        ...
        "&([ScriptBlock]::Create((irm https://github.com//winutil/releases/latest/download/winutil.ps1))) $($argList -join ' ')"
    }
...
$winutildir = "$env:LocalAppData\pctg-system-master"
New-Item $winutildir -ItemType Directory -Force | Out-Null

$logdir = "$winutildir\logs"
New-Item $logdir -ItemType Directory -Force | Out-Null
Start-Transcript -Path "$logdir\pctg-master_$dateTime.log" -Append -NoClobber | Out-Null

# Set PowerShell window title
$Host.UI.RawUI.WindowTitle = "PCTG System Master (Admin)"
clear-host
...
function Invoke-WinUtilInstallPSProfile {
    ...
    wt new-tab pwsh -NoExit -Command "irm https://github.com//powershell-profile/raw/main/setup.ps1 | iex"
}
...
function Invoke-WinUtilISOModify {
    ...
    $existingWorkDir = Get-Item -Path (Join-Path $env:TEMP "pctg-master_Win11ISO*") |
    ...
    $workDir = if ($existingWorkDir) {
        ...
        Join-Path $env:TEMP "pctg-master_Win11ISO_$(Get-Date -Format 'yyyyMMdd_HHmmss')"
    }
    ...
    $script.AddScript({
        ...
        function Log($msg) {
            ...
            Add-Content -Path (Join-Path $workDir "pctg-master_Win11ISO.log") -Value "[$ts] $msg"
        }
...
function Invoke-WinUtilISOScript {
    ...
    function Invoke-BootWimInject {
        ...
        $mountDir = Join-Path $env:TEMP "pctg-master_BootMount_$(Get-Random)"
    ...
    if ($InjectCurrentSystemDrivers) {
        ...
        $driverExportRoot = Join-Path $env:TEMP "pctg-master_DriverExport_$(Get-Random)"
...
function Invoke-WinUtilISOWriteUSB {
    ...
    $script.AddScript({
        ...
        try {
            ...
            $dpFile1 = Join-Path $env:TEMP "pctg-master_diskpart_$(Get-Random).txt"
            ...
            if (($dpCleanOut -join ' ') -match 'device is not ready') {
                ...
                $dpFile1b = Join-Path $env:TEMP "pctg-master_diskpart_$(Get-Random).txt"
            ...
            $dpFile2  = Join-Path $env:TEMP "pctg-master_diskpart2_$(Get-Random).txt"
...
Function Invoke-WinUtilSponsors {
    ...
    .NOTES
        This function is used to list sponsors from 
    #>
    try {
        ...
        # Exclude "" from the sponsors
        $sponsors = $sponsors | Where-Object { $_ -ne "" }
...
function Invoke-WPFButton {
    ...
    #[System.Windows.MessageBox]::Show("$Button","PCTG's Windows Utility","OK","Info")
        ...
        "export" {
            try {
                ...
                if ($Config) {
                    ...
                    "iex ""& { `$(irm https://PCTG.com/win) } -Config '$Config'""" | Set-Clipboard
                }
            } catch {
...
function Invoke-WPFUltimatePerformance {
    ...
    if ($Do) {
        if (-not (powercfg /list | Select-String "PCTG - Ultimate Power Plan")) {
            ...
            powercfg /changename $guid "PCTG - Ultimate Power Plan"
            ...
            Write-Host "PCTG - Ultimate Power Plan plan installed and activated." -ForegroundColor Green
        } else {
            Write-Host "PCTG - Ultimate Power Plan plan is already installed." -ForegroundColor Red
            return
        }
    } else {
        if (powercfg /list | Select-String "PCTG - Ultimate Power Plan") {
            powercfg /setactive SCHEME_BALANCED
            powercfg /delete ((powercfg /list | Select-String "PCTG - Ultimate Power Plan").ToString().Split()[3])
            Write-Host "PCTG - Ultimate Power Plan plan was removed." -ForegroundColor Red
        } else {
            Write-Host "PCTG - Ultimate Power Plan plan is not installed." -ForegroundColor Yellow
        }
    }
}
...
$sync.configs.feature = @'
{
  "WPFFeaturesdotnet": {
    ...
    "InvokeScript": [],
    "link": "https://winutil.PCTG.com/dev/features/features/dotnet"
  },
  "WPFFixesNTPPool": {
    ...
    "ButtonWidth": "300",
    "function": "Invoke-WPFFixesNTPPool",
    "link": "https://winutil.PCTG.com/dev/features/fixes/ntppool"
  },
  "WPFFeatureshyperv": {
    ...
    "link": "https://winutil.PCTG.com/dev/features/features/hyperv"
  },
  "WPFFeatureslegacymedia": {
    ...
    "InvokeScript": [],
    "link": "https://winutil.PCTG.com/dev/features/features/legacymedia"
  },
  "WPFFeaturewsl": {
    ...
    "InvokeScript": [],
    "link": "https://winutil.PCTG.com/dev/features/features/wsl"
  },
  "WPFFeaturenfs": {
    ...
    "link": "https://winutil.PCTG.com/dev/features/features/nfs"
  },
  "WPFFeatureRegBackup": {
    ...
    "link": "https://winutil.PCTG.com/dev/features/features/regbackup"
  },
  "WPFFeatureEnableLegacyRecovery": {
    ...
    "link": "https://winutil.PCTG.com/dev/features/features/enablelegacyrecovery"
  },
  "WPFFeatureDisableLegacyRecovery": {
    ...
    "link": "https://winutil.PCTG.com/dev/features/features/disablelegacyrecovery"
  },
  "WPFFeaturesSandbox": {
    ...
    "link": "https://winutil.PCTG.com/dev/features/features/sandbox"
  },
  "WPFFeatureInstall": {
    ...
    "ButtonWidth": "300",
    "function": "Invoke-WPFFeatureInstall",
    "link": "https://winutil.PCTG.com/dev/features/features/install"
  },
  "WPFPanelAutologin": {
    ...
    "ButtonWidth": "300",
    "function": "Invoke-WPFPanelAutologin",
    "link": "https://winutil.PCTG.com/dev/features/fixes/autologin"
  },
  "WPFFixesUpdate": {
    ...
    "ButtonWidth": "300",
    "function": "Invoke-WPFFixesUpdate",
    "link": "https://winutil.PCTG.com/dev/features/fixes/update"
  },
  "WPFFixesNetwork": {
    ...
    "ButtonWidth": "300",
    "function": "Invoke-WPFFixesNetwork",
    "link": "https://winutil.PCTG.com/dev/features/fixes/network"
  },
  "WPFPanelDISM": {
    ...
    "ButtonWidth": "300",
    "function": "Invoke-WPFSystemRepair",
    "link": "https://winutil.PCTG.com/dev/features/fixes/dism"
  },
  "WPFFixesWinget": {
    ...
    "ButtonWidth": "300",
    "function": "Invoke-WPFFixesWinget",
    "link": "https://winutil.PCTG.com/dev/features/fixes/winget"
  },
  "WPFPanelControl": {
    ...
    "link": "https://winutil.PCTG.com/dev/features/legacy-windows-panels/control"
  },
  "WPFPanelComputer": {
    ...
    "link": "https://winutil.PCTG.com/dev/features/legacy-windows-panels/computer"
  },
  "WPFPanelNetwork": {
    ...
    "link": "https://winutil.PCTG.com/dev/features/legacy-windows-panels/network"
  },
  "WPFPanelPower": {
    "Content": "Power Panel",
    "category": "Legacy Windows Panels",
    ...
    "link": "https://winutil.PCTG.com/dev/features/legacy-windows-panels/power"
  },
  "WPFPanelPrinter": {
    ...
    "link": "https://winutil.PCTG.com/dev/features/legacy-windows-panels/printer"
  },
  "WPFPanelRegion": {
    "Content": "Region",
    "category": "Legacy Windows Panels",
    ...
    "link": "https://winutil.PCTG.com/dev/features/legacy-windows-panels/region"
  },
  "WPFPanelRestore": {
    ...
    "link": "https://winutil.PCTG.com/dev/features/legacy-windows-panels/restore"
  },
  "WPFPanelSound": {
    ...
    "link": "https://winutil.PCTG.com/dev/features/legacy-windows-panels/sound"
  },
  "WPFPanelSystem": {
    ...
    "link": "https://winutil.PCTG.com/dev/features/legacy-windows-panels/system"
  },
  "WPFPanelTimedate": {
    ...
    "link": "https://winutil.PCTG.com/dev/features/legacy-windows-panels/timedate"
  },
  "WPFWinUtilInstallPSProfile": {
    ...
    "ButtonWidth": "300",
    "function": "Invoke-WinUtilInstallPSProfile",
    "link": "https://winutil.PCTG.com/dev/features/powershell-profile-powershell-7--only/installpsprofile"
  },
  "WPFWinUtilUninstallPSProfile": {
    ...
    "ButtonWidth": "300",
    "function": "Invoke-WinUtilUninstallPSProfile",
    "link": "https://winutil.PCTG.com/dev/features/powershell-profile-powershell-7--only/uninstallpsprofile"
  },
  "WPFWinUtilSSHServer": {
    ...
    "ButtonWidth": "300",
    "function": "Invoke-WPFSSHServer",
    "link": "https://winutil.PCTG.com/dev/features/remote-access/sshserver"
  }
}
'@ | ConvertFrom-Json
$sync.configs.preset = @'
...
$sync.configs.tweaks = @'
{
  "WPFTweaksActivity": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/essential-tweaks/activity"
  },
  "WPFTweaksHiber": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/essential-tweaks/hiber"
  },
  "WPFTweaksWidget": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/essential-tweaks/widget"
  },
  "WPFTweaksRevertStartMenu": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/essential-tweaks/revertstartmenu"
  },
  "WPFTweaksDisableStoreSearch": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/essential-tweaks/disablestoresearch"
  },
  "WPFTweaksLocation": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/essential-tweaks/location"
  },
  "WPFTweaksServices": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/essential-tweaks/services"
  },
  "WPFTweaksBraveDebloat": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/z--advanced-tweaks---caution/bravedebloat"
  },
  "WPFTweaksDisableWarningForUnsignedRdp": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/z--advanced-tweaks---caution/disablewarningforunsignedrdp"
  },
  "WPFTweaksEdgeDebloat": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/z--advanced-tweaks---caution/edgedebloat"
  },
  "WPFTweaksConsumerFeatures": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/essential-tweaks/consumerfeatures"
  },
  "WPFTweaksTelemetry": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/essential-tweaks/telemetry"
  },
  "WPFTweaksRemoveEdge": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/z--advanced-tweaks---caution/removeedge"
  },
  "WPFTweaksUTC": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/z--advanced-tweaks---caution/utc"
  },
  "WPFTweaksRemoveOneDrive": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/z--advanced-tweaks---caution/removeonedrive"
  },
  "WPFTweaksRemoveHome": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/z--advanced-tweaks---caution/removehome"
  },
  "WPFTweaksDisplay": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/z--advanced-tweaks---caution/display"
  },
  "WPFTweaksXboxRemoval": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/z--advanced-tweaks---caution/xboxremoval"
  },
  "WPFTweaksDeBloat": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/essential-tweaks/debloat"
  },
  "WPFTweaksRestorePoint": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/essential-tweaks/restorepoint"
  },
  "WPFTweaksEndTaskOnTaskbar": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/essential-tweaks/endtaskontaskbar"
  },
  "WPFTweaksPowershell7Tele": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/essential-tweaks/powershell7tele"
  },
  "WPFTweaksStorage": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/z--advanced-tweaks---caution/storage"
  },
  "WPFTweaksWindowsAI": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/z--advanced-tweaks---caution/windowsai"
  },
  "WPFTweaksWPBT": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/essential-tweaks/wpbt"
  },
  "WPFTweaksRazerBlock": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/z--advanced-tweaks---caution/razerblock"
  },
  "WPFTweaksDisableNotifications": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/z--advanced-tweaks---caution/disablenotifications"
  },
  "WPFTweaksBlockAdobeNet": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/z--advanced-tweaks---caution/blockadobenet"
  },
  "WPFTweaksRightClickMenu": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/z--advanced-tweaks---caution/rightclickmenu"
  },
  "WPFTweaksDiskCleanup": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/essential-tweaks/diskcleanup"
  },
  "WPFTweaksDeleteTempFiles": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/essential-tweaks/deletetempfiles"
  },
  "WPFTweaksIPv46": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/z--advanced-tweaks---caution/ipv46"
  },
  "WPFTweaksTeredo": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/z--advanced-tweaks---caution/teredo"
  },
  "WPFTweaksDisableIPv6": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/z--advanced-tweaks---caution/disableipv6"
  },
  "WPFTweaksDisableBGapps": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/z--advanced-tweaks---caution/disablebgapps"
  },
  "WPFTweaksDisableFSO": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/z--advanced-tweaks---caution/disablefso"
  },
  "WPFToggleDisableCrossDeviceResume": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/customize-preferences/disablecrossdeviceresume"
  },
  "WPFToggleDetailedBSoD": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/customize-preferences/detailedbsod"
  },
  "WPFToggleBatteryPercentage": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/customize-preferences/batterypercentage"
  },
  "WPFToggleDarkMode": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/customize-preferences/darkmode"
  },
  "WPFToggleShowExt": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/customize-preferences/showext"
  },
  "WPFToggleHiddenFiles": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/customize-preferences/hiddenfiles"
  },
  "WPFToggleVerboseLogon": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/customize-preferences/verboselogon"
  },
  "WPFToggleNewOutlook": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/customize-preferences/newoutlook"
  },
  "WPFToggleScrollbars": {
    ...
    "registry": [
      {
        ...
        "OriginalValue": "1",
        "DefaultState": "false",
        "link": "https://winutil.PCTG.com/dev/tweaks/customize-preferences/scrollbars"
      }
    ],
    "link": "https://winutil.PCTG.com/dev/tweaks/customize-preferences/scrollbars"
  },
  "WPFToggleMultiplaneOverlay": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/customize-preferences/multiplaneoverlay"
  },
  "WPFToggleMouseAcceleration": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/customize-preferences/mouseacceleration"
  },
  "WPFToggleNumLock": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/customize-preferences/numlock"
  },
  "WPFToggleStandbyFix": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/customize-preferences/standbyfix"
  },
  "WPFToggleS3Sleep": {
    "Content": "S3 Sleep",
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/customize-preferences/s3sleep"
  },
  "WPFToggleHideSettingsHome": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/customize-preferences/hidesettingshome"
  },
  "WPFToggleBingSearch": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/customize-preferences/bingsearch"
  },
  "WPFToggleLoginBlur": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/customize-preferences/loginblur"
  },
  "WPFToggleStartMenuRecommendations": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/customize-preferences/startmenurecommendations"
  },
  "WPFToggleStickyKeys": {
    "Content": "Sticky Keys",
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/customize-preferences/stickykeys"
  },
  "WPFToggleTaskbarAlignment": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/customize-preferences/taskbaralignment"
  },
  "WPFToggleTaskbarSearch": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/customize-preferences/taskbarsearch"
  },
  "WPFToggleTaskView": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/customize-preferences/taskview"
  },
  "WPFOOSUbutton": {
    ...
    "panel": "1",
    "Type": "Button",
    "link": "https://winutil.PCTG.com/dev/tweaks/z--advanced-tweaks---caution/oosubutton"
  },
  "WPFchangedns": {
    "Content": "DNS - Set to:",
    "category": "z__Advanced Tweaks - CAUTION",
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/z--advanced-tweaks---caution/changedns"
  },
  "WPFAddUltPerf": {
    ...
    "Type": "Button",
    "ButtonWidth": "300",
    "link": "https://winutil.PCTG.com/dev/tweaks/performance-plans/addultperf"
  },
  "WPFRemoveUltPerf": {
    ...
    "Type": "Button",
    "ButtonWidth": "300",
    "link": "https://winutil.PCTG.com/dev/tweaks/performance-plans/removeultperf"
  },
  "WPFTweaksDisableExplorerAutoDiscovery": {
    ...
    "link": "https://winutil.PCTG.com/dev/tweaks/essential-tweaks/disableexplorerautodiscovery"
  }
}
'@ | ConvertFrom-Json
$inputXML = @'
...
GitHub   : <a href="https://github.com//winutil">/winutil</a>
Version  : <a href="https://github.com//winutil/releases/tag/$($sync.version)">$($sync.version)</a>
"@
...
$sync["DocumentationMenuItem"].Add_Click({
    ...
    Invoke-WPFPopup -Action "Hide" -Popups @("Settings")
    Start-Process "https://winutil.PCTG.com/"
})
$sync["SponsorMenuItem"].Add_Click({
    ...
    $authorInfo = @"
<a href="https://github.com/sponsors/">Current sponsors for :</a>
"@
    $authorInfo += "`n"
    try {
        $sponsors = Invoke-WinUtilSponsors
        foreach ($sponsor in $sponsors) {
            $authorInfo += "<a href=`"https://github.com/sponsors/`">$sponsor</a>`n"
        }
    } catch {
